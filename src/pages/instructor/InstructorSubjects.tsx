...
const fallbackSubjects: Subject[] = [
  ...
  { id: "MTH201", name: "Mathematics" },
  { id: "SCI301", name: "Science" },
];
        ...
        <main className="flex-1 p-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {subjects.map((s) => (
                <Card key={s.id} className="cursor-pointer hover:shadow-md" onClick={() => navigate(`/instructor/assessment/${encodeURIComponent(s.id)}`)}>
                  <CardHeader>
